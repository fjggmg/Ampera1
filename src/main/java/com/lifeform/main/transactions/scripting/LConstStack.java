...
public class LConstStack implements IOperator {
    @Override
    ...
    public int getBaseCode() {
        return Opcodes.LCONSTSTACK.getCode();
    }
    ...
    public void execute(Stack<DataElement> stack, Binary binary, Program program, ConstantMemory constantMemory, JumpMemory jumpMemory, WritableMemory writableMemory, OPCode opCode, ITrans transaction, byte[] executionAddress) throws Exception {
        ...
        //System.out.println("pulling const from: " + add);
        DataElement c = constantMemory.getElement(add);
        //System.out.println("const is: " + c);
        stack.push(c);
    }

    @Override
    public String getKeyword() {
        return Opcodes.LCONSTSTACK.getKeyword();
    }
}
