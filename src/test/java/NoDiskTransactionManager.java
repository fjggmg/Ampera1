...
public class NoDiskTransactionManager extends Thread implements ITransMan{
    ...
    public ITrans createSimpleMultiSig(IBinary bin, IAddress receiver, BigInteger amount, BigInteger fee, Token token, String message, int multipleOuts, IAddress changeAddress) throws InvalidTransactionException {
        if (ki.getEncryptMan().getPublicKey(ki.getAddMan().getMainAdd().getKeyType()) != null) {
            ...
            keySigMap.put(com.ampex.main.data.utils.Utils.toBase64(bin.serializeToAmplet().serializeToBytes()), ksep);
            ...
            for (; i < 32; i++) {
                try {
                    ...
                    if (ki.getEncryptMan().getPublicKeyString(kktp.getKeyType()).equals(com.ampex.main.data.utils.Utils.toBase64(kktp.getKey()))) {
            ...
            trans.addSig(com.ampex.main.data.utils.Utils.toBase64(bin.serializeToAmplet().serializeToBytes()), com.ampex.main.data.utils.Utils.toBase64(wm.serializeToBytes()));
